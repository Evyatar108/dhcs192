...
def find_named_entity(named_entities, target_spans: Iterator[Tuple[int, int]], indx_chapter,
                        target_names: Generator[str],
                        is_same_name_pred: Callable[[str, str], bool]) -> NamedEntity:
    return next(find_named_entities(named_entities, target_spans, indx_chapter, target_names, is_same_name_pred))

def find_named_entities(named_entities, target_spans: Iterator[Tuple[int, int]], indx_chapter,
                        target_names: Generator[str],
                        is_same_name_pred: Callable[[str, str], bool]) -> Iterator[NamedEntity]:
